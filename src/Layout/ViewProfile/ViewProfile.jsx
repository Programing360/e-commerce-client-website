import { FaShoppingCart, FaUserCircle, FaEllipsisV, FaShopify, FaUserCheck } from "react-icons/fa";
...
const ViewProfile = () => {
    ...
    return (
        <div className="drawer lg:container lg:w-1/2 mx-auto mt-4">
                ...
                <nav className="w-full bg-white  px-4 py-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="flex items-center justify-center ml-10">
                            <div>
                                <Link to='/'>
                                    <button className="hidden md:block text-15 p-2 rounded-lg hover:bg-gray-100 mt-1">Shop</button>
                                </Link>
                            </div>
                            <div>
                                <Link to='/profile'>
                                    <button className="hidden md:block text-15 p-2 rounded-lg hover:bg-gray-100 mt-1">Order</button>
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:flex items-center gap-4 text-xl">
                        ...
                        <div className="dropdown dropdown-end">
                            ...
                            >
                                <li><a>Profile</a></li>
                                <Link to='/profile/setting'><li><a>Setting</a></li></Link>
                                <li onClick={userLogOut}><a className="text-red-500">Logout</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
            ...
            <div className=" drawer-side mt-26 w-full">
                <label htmlFor="dashboard-drawer" className="drawer-overlay block md:hidden"></label>

                <ul className="menu p-4 w-2/3 min-h-full bg-base-200 space-y-3 block md:hidden">
                    <li className="text-lg font-bold text-amber-600">E-Shop</li>

                    <div className="border-b w-full text-center mx-auto">
                        {
                            user && <div className="flex items-center gap-2 pb-2">
                                <FaUserCheck />
                                <p>{user.email}</p>
                            </div>
                        }
                ...
                <div className="mt-150 border-t border-t-gray-300 w-3/5">
